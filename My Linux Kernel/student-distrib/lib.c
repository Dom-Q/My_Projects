...
/* 
    ...
    inputs: none
    outputs: none
    side_effects: sets new cursor location and changes locations attributes
*/
void update_cursor()
{
    ...
    *(uint8_t *)(video_mem + ((new_location) << 1) + 1) = ATTRIB; //reset attrib in case it was set to zero by scroll
    ...
    outb(0x0E, 0x3D4);
    outb((uint8_t)((new_location >> 8) & 0xFF), 0x3D5);
}
...
/* 
    ...
    Description: sets screen location to top left
    inputs: none
    outputs: none
    side_effects: sets screen location
*/
...
/* 
    ...
    Description: sets screen location to bottom left
    inputs: none
    outputs: none
    side_effects: sets screen location
*/
void move_bottom_left(void)
{
    screen_x = 0;
    screen_y = NUM_ROWS - 1; // offset for zero index
}

/* 
    Function: get_screen_x
    Description: gets screen_x value
    inputs: none
    outputs: screen_x
    side_effects: none
*/
...
/* 
    ...
    Description: gets screen_y value
    inputs: none
    outputs: screen_y
    side_effects: none
*/
...
/* 
    ...
    Description: sets screen_x value
    inputs: x: new value
    outputs: none
    side_effects: sets screen_x
*/
...
/* 
    ...
    Description: sets screen_y value
    inputs: y: new value
    outputs: none
    side_effects: sets screen_y
*/
...
/* 
    Function: scroll
    Description: add a new line by moving memory up one line (160 bytes)
    inputs: none
    outputs: none
    side_effects: moves all video mem up one line and then sets value of bottom line to zero
*/
void scroll(void)
{
    ...
    memmove(video_mem, newl, cut_size);
    memset(endl, 0, line_size);
}
